...
(function() {
  $(document).on('page:change', function() {
    var insert_course;
    insert_course = function(data) {
      if (!jQuery.isEmptyObject(data)) {
        $('#title').html("" + data[0].course_name + " - " + data[0].professor);
      }
      if (!jQuery.isEmptyObject(data)) {
        $('#current_isbn_list_div').html("Already have these books: " + data[0].isbn + " " + data[0].pinned_isbn);
      }
    };
    return $('#booklistsuggestion_section,#booklistsuggestion_crn').blur(function() {
      var callback, crn, gwid, section;
...
(function() {
  $(document).on('page:change', function() {
    $('#popular_courses_header').click(function() {
      $('#popular_courses_div').slideToggle('slow');
    });
    return $('#all_courses_header').click(function() {
...
(function() {
  $(document).on('page:change', function() {
    var insert_course, insert_course_name;
    insert_course = function(data) {
      if (!jQuery.isEmptyObject(data)) {
        $('#title').html("" + data[0].course_name + " - " + data[0].professor);
      }
    ...
    $('#booklistsuggestion_section,#booklistsuggestion_crn').blur(function() {
      var callback, crn, gwid, section;
      section = $('#booklistsuggestion_section').val();
      gwid = $('#booklistsuggestion_gwid').val();
      crn = $('#booklistsuggestion_crn').val();
    ...
    insert_course_name = function(data) {
      if (!jQuery.isEmptyObject(data)) {
        $('#course_name').html("" + data[0].course_name + " - " + data[0].professor);
      }
      $('.add_missing_book_div').slideUp(300);
    };
    return $('#feedback_section,#feedback_crn').blur(function() {
      var callback, crn, gwid, section;
      ...
      console.log(gwid, section);
      callback = function(response) {
        return insert_course_name(response);
      };
      $.get('/addtobooklist/get_course/', {
        gwid: gwid,
        section: section,
